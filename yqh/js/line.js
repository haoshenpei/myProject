(function(main) {
    ...
    Rect.prototype = {
        ...
        render: function(ctx) {
            ...
            ctx.fillStyle = 'rgba(236,247,236,0.1)';
            ctx.transform(
                Math.cos(this.a),
    ...
    requestAnimationFrame(function loop() {
        ...
        var radialGradient1 =
        ctx.createRadialGradient(WIDTH / 2, HEIGHT / 2, WIDTH / 8, WIDTH / 2, HEIGHT / 2,HEIGHT / 2);
        radialGradient1.addColorStop(0, 'rgb(20,209,252)');
        radialGradient1.addColorStop(1, 'rgb(19,30,60)');
